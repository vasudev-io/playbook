...
description: Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use whenever building, reviewing, or improving UI motion: animations, transitions, easing, springs, hover/tap feedback, modals, drawers, dropdowns, toasts, tabs, reveals, drag/gesture, stagger, performance, or any "make it feel nicer / smoother / more alive" request.
---
